		...
		<table class="flat-table-1">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1" type="submit" name="name" value="Sanjay">View</button>
						</form>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1" type="submit" name="name" value="Dipika">View</button>
						</form>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1"type="submit" name="name" value="Mr.Abhishek">View</button>
						</form>
					</td>
				</tr>
			</tbody>
